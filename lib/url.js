...
const possiblePlainPrefixes = [for (protocol of PROTOCOLS) protocol + colonGroup].concat("www\\.");
const possiblePlainPrefixesString = "(?:" + possiblePlainPrefixes.join("|") + ")";

const possibleBase64Prefixes =        [for (protocol of PROTOCOLS) base64.encode(protocol + "://").slice(0, -4)].concat(base64.encode("www"));
const possibleBase64PrefixesDecoded = [for (protocol of PROTOCOLS)               protocol + "://"              ].concat(              "www\\.");
